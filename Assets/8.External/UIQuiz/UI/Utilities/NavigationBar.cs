...
namespace Quiz
{
    ...
    public class NavigationBar
    {
        ...
        const int k_TextSize = 45;  // Fallback text size if font-size is not set
        ...
        public void SetButtonLabelText(Button button, string labelText)
        {
            ...
            // Respect USS-defined font size when present; only use fallback when unset.
            if (label.style.fontSize.keyword == StyleKeyword.Null)
            {
